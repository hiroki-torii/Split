...
btn.addEventListener("click", ()=>{
    ...
    if (ratio_grade3.value == '' || ratio_grade3.value == 0 || num_grade3.value == '' || num_grade3.value == 0){
        ratio_grade3.value = 0;
        num_grade3.value = 0;
    }
    if (ratio_grade2.value == '' || ratio_grade2.value == 0 || num_grade2.value == '' || num_grade2.value == 0){
        ratio_grade2.value = 0;
        num_grade2.value = 0;
    }
    if (ratio_grade1.value == '' || ratio_grade1.value == 0 || num_grade1.value == '' || num_grade1.value == 0){
        ratio_grade1.value = 0;
        num_grade1.value = 0;
    }
    
    if (ratio_grade3.value * num_grade3.value + ratio_grade2.value * num_grade2.value + ratio_grade1.value * num_grade1.value == 0){
        cost_grade3.value = 0;
        cost_grade2.value = 0;
        cost_grade1.value = 0;
        sum_people.value = 0;
        collect_money.value = 0;
        change.value = 0;
        average.value = 0;
    }
